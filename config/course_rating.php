...
return [
    ...
    */
    'on_site' => [
        ...
        ['id' => 'suggestions',             'section' => 'أسئلة عامة', 'type' => 'text', 'target' => 'academy', 'required' => false,
    ...
    */
    'recorded' => [
        ...
        ['id' => 'suggestions',             'section' => 'أسئلة عامة ومقترحات', 'type' => 'text', 'target' => 'academy', 'required' => false,
