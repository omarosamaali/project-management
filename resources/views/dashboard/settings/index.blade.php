...
<section class="!pl-0 p-3 sm:p-5">
    <x-breadcrumb first="الرئيسية" link="{{ route('dashboard.settings.index') }}" second="الإعدادات" />
    <div class="mx-auto w-full">
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-1/2">
                    <form action="{{ route('dashboard.settings.index') }}" method="GET" class="flex items-center">
                ...
                <table class="w-full text-sm text-right text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">الدور</th>
                    ...
                    @if($settingss->isNotEmpty())
                    @foreach($settingss as $partner)
                    <tbody>
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="dropdown-{{ $partner->id }}"
                                    ...
                                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                        ...
                                        <li>
                                            <a href="{{ route('dashboard.settings.show', $partner) }}"
                                                class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                عرض
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('dashboard.settings.edit', $partner->id) }}"
                                                class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                تعديل
                                            </a>
                                        </li>
                                    ...
                                    <div class="py-1">
                                        <form action="{{ route('dashboard.settings.destroy', $partner) }}"
