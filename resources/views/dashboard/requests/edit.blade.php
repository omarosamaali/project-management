            ...
            <form method="POST" action="{{ route('dashboard.requests.update', $userRequest->id) }}" class="space-y-6">
                ...
                <div class="border-b pb-6">
                    ...
                    <div class="flex gap-4 flex-wrap">
                        ...
                        <!-- جديد (أخضر) -->
                        <label
                            class="flex items-center gap-3 p-4 border-2 border-purple-300 bg-purple-50 rounded-lg cursor-pointer hover:bg-green-100">
                            <input type="radio" name="status" value="منتهية" {{ old('status', $userRequest->status) ==
                            'منتهية' ? 'checked' : '' }}
                            class="w-5 h-5 text-purple-600">
                            <span class="font-medium text-purple-700">منتهية</span>
                        </label>
