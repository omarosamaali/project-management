...
<section class="!px-0 p-3 sm:p-5">
    <x-breadcrumb first="الرئيسية" link="{{ route('dashboard.my-store.index') }}" second="متجري" third="تعديل المتجر" />
    ...
    <div class="mx-auto max-w-4xl w-full rounded-xl">
        <div class="p-3 bg-white dark:bg-gray-800 relative shadow-xl border rounded-xl overflow-hidden">
            ...
            <form action="{{ route('dashboard.my-store.update', $system->id) }}" method="POST"
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                إسم المتجر (بالعربي) <span class="text-black">*</span>
                            </label>
                            ...
                            <div class="grid grid-cols-1 gap-2">
                                <div class="relative">
                                    <input type="number" name="execution_days" required min="0"
                                        value="{{ old('execution_days', $system->execution_days) }}"
                                        class="placeholder-gray-400 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                        placeholder="10">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="support_days" required min="0" step="1"
                                    value="{{ old('support_days', $system->support_days) }}"
                                    class="placeholder-gray-400 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                    placeholder="365 يوم">
                                @error('support_days')
                                <span class="text-black text-xs mt-1">{{ $message }}</span>
                        ...
                        <div>
                            ...
                            <input type="number" id="original_price_input" name="original_price" required min="0"
                                step="1" value="{{ old('original_price', $system->original_price ?? $system->price) }}"
                        ...
                        <div>
                            ...
                            <select id="service_id" name="service_id" required
                                ...
                                <option value="{{ $service->id }}"
                                    data-commission="{{ $service->evork_commission ?? 0 }}" {{ $service->id ==
                                    old('service_id', $system->service_id) ? 'selected' : '' }}>
        ...
        updateFinalPrice();
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description_ar" id="description_ar" required rows="4"
                                class="placeholder-gray-400 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="متجر متكامل لإدارة المبيعات والمخزون، والعطاءات مع متجر محاسبي مبسط وواجهة سهلة الاستخدام">{{ old('description_ar', $system->description_ar) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea required name="description_en" id="description_en" rows="4" dir="ltr"
                                class="placeholder-gray-400 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Integrated system for sales and inventory management...">{{ old('description_en', $system->description_en) }}</textarea>
                ...
                <div class="border-b pb-6">
                    ...
                    <div id="requirements-container" class="space-y-3">
                        @forelse($system->requirements as $requirement)
                ...
                <div class="border-b pb-6">
                    ...
                    <div id="features-container" class="space-y-3">
                        @forelse($system->features as $feature)
                ...
                <div class="border-b pb-6">
                    ...
                    <div id="buttons-container" class="space-y-4">
                        ...
                        $systemButtons[] = ['text_ar' => '', 'text_en' => '', 'link' => '', 'color' => '#3B82F6'];
                        }
                        @endphp
                        ...
                        <div class="button-row border border-gray-200 rounded-lg p-4 bg-gray-50">
                            <div class="grid md:grid-cols-2 gap-4 mb-3">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="buttons_text_ar[]" value="{{ $textAr }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="buttons_text_en[]" dir="ltr" value="{{ $textEn }}"
                                        class="placeholder-gray-400 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                            ...
                            <div class="grid md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="url" name="buttons_link[]" dir="ltr" value="{{ $link }}"
                                        class="placeholder-gray-400 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <p class="text-sm text-gray-600">اضغط لتغيير الصورة</p>
                            </div>
                            @error('main_image')
                            <span class="text-black text-xs mt-1">{{ $message }}</span>
                            @enderror
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <p class="text-sm text-gray-600">إضافة صور جديدة</p>
                            </div>
                            @error('images.*')
                            <span class="text-black text-xs mt-1">{{ $message }}</span>
                            @enderror
