                ...
                <table class="w-full text-sm text-right text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">الإسم بالعربي</th>
                            <th scope="col" class="px-4 py-3">الإسم بالانجليزي</th>
                    ...
                    <tbody>
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3">
                                <img class="w-20 h-14 rounded" src="{{ asset('storage/' . $service->image) }}" alt="">
                            </td>
                            <td class="px-4 py-3">
                                {{ $service->name_ar }}
                            </td>
