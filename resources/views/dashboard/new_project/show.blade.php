        ...
        <div
            ...
            <form action="{{ route('dashboard.new_project.store_proposal', $newProject->id) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="text-sm font-bold flex items-center text-gray-700 dark:text-gray-300">
                            قيمة العرض
                        </label>
                    ...
                    <div class="space-y-2">
                        <label class="block text-sm font-bold text-gray-700 dark:text-gray-300">مدة التسليم</label>
                ...
                <div class="flex items-center justify-between gap-4 pt-6 border-t dark:border-gray-700">
                    <button type="submit"
                        ...
                        {{ $myProposal ? 'تحديث العرض الحالي' : 'إرسال العرض المالي والتقني' }}
                    </button>

                    @if($myProposal)
                    <span class="text-xs text-green-500 font-medium italic">
                        <i class="fas fa-info-circle"></i> لقد قمت بتقديم عرض مسبقاً، يمكنك تعديله الآن.
                    </span>
                    @endif
                </div>
            </form>
