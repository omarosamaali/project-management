            ...
            <div class="p-6 border-b bg-gradient-to-r from-blue-50 to-blue-50 dark:from-gray-700 dark:to-gray-800">
                <div class="flex justify-between items-start">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('dashboard.my_services.edit', $myService) }}"
                ...
                <div class="border-b pb-6">
                    ...
                    <div class="grid md:grid-cols-1 gap-6">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                            <label
                                class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">العنوان</label>
                            <span class="text-lg font-bold text-gray-900 dark:text-white">{{ $myService->title }}</span>
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                            ...
                            <span class="text-lg font-bold text-blue-600 dark:text-blue-400">{{
                                $myService->service->name_ar }}</span>
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                            ...
                            <span class="text-lg font-bold text-blue-600 dark:text-blue-400 flex items-center">{{
                                $myService->price }}
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                            ...
                            <span class="text-lg font-semibold text-gray-900 dark:text-white">
                                {{ $myService->created_at->format('Y-m-d H:i') }}
                            </span>
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                            <label class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">آخر
                                تحديث</label>
                            <span class="text-lg font-semibold text-gray-900 dark:text-white">
                                {{ $myService->updated_at->format('Y-m-d H:i') }}
                            </span>
                        </div>
                    </div>
                </div>
