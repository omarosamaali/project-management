...
<div id="private_trainer_profit_preview"
    ...
    <div class="flex items-start gap-3">
        ...
        <div class="min-w-0 flex-1 space-y-3">
            <p class="text-xs font-bold text-emerald-800">ربح المحاضر لكل دورة خاصة</p>
            ...
            <div class="space-y-2 text-sm">
                <div class="flex items-center justify-between gap-4">
                    ...
                    <span class="inline-flex items-center gap-1 font-semibold text-slate-800 tabular-nums" dir="ltr">
                        <span id="tpp_price">—</span>
                        <x-drhm-icon width="12" height="14" />
                    </span>
                </div>
                <div class="flex items-center justify-between gap-4">
                    <span class="text-slate-600">رسوم المنصة <span class="text-slate-400">(<span id="tpp_platform_pct_label">{{ $fmtPct($platformFeePct) }}</span>%)</span></span>
                    <span class="inline-flex items-center gap-1 font-semibold text-slate-800 tabular-nums" dir="ltr">
                        <span id="tpp_fee">—</span>
                        <x-drhm-icon width="12" height="14" />
                    </span>
                </div>
            ...
            <div class="space-y-1.5 pt-1 border-t border-emerald-200/60">
                <div class="flex items-center justify-between gap-4 text-xs">
                    ...
                    <span id="tpp_egp" class="font-semibold text-slate-800 tabular-nums" dir="ltr">—</span>
                </div>
                <div class="flex items-center justify-between gap-4 text-[11px] text-slate-400">
                    ...
                    <span class="inline-flex items-center gap-1 tabular-nums" dir="ltr">
                        ...
                        <span>=</span>
                        <span id="tpp_rate">—</span>
                    </span>
                </div>
            </div>

            <p class="text-[11px] text-slate-400 leading-relaxed pt-0.5">
                نسبة ربح الدورة الخاصة
                <bdi dir="ltr"><span id="tpp_trainer_pct_label">{{ $fmtPct($trainerProfitPct) }}</span>%</bdi>
                <span class="mx-1 text-slate-300">·</span>
                رسوم المنصة
                <bdi dir="ltr"><span id="tpp_platform_pct_label_2">{{ $fmtPct($platformFeePct) }}</span>%</bdi>
            </p>
        </div>
    </div>
</div>
