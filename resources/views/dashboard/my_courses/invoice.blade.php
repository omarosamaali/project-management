                        ...
                        <tbody class="divide-y divide-gray-200">
                           {{--  --}}
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="text-center py-3 px-4 text-gray-600 font-semibold">{{ $payment->course->name_ar }}</td>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="flex items-center gap-1 mx-auto justify-center text-center py-3 px-4 text-gray-600 font-semibold">{{ number_format($base, 2)
                                    }} <x-drhm-icon width="12" height="14" /> </td>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="flex items-center gap-1 mx-auto justify-center text-center py-3 px-4 text-gray-600 font-semibold">{{ number_format($fees, 2)
                                    }} <x-drhm-icon width="12" height="14" /> </td>
                            ...
                            <tr class="bg-gray-50">
                                ...
                                <td class="flex items-center gap-1 mx-auto justify-center text-center py-3 px-4 text-black font-bold text-xl">{{ number_format($total,
                                    2) }} <x-drhm-icon width="12" height="14" /> </td>
